...
const {takeOrder,saveOrder, viewOrder,completeOrder,kitchenView,kitchenUpdate,orderHistory,trashOrder,trashHistory} = require("../controllers/orderControllers")
...
router.post("/trash/:orderId",isloggedin, trashOrder)
...
router.get("/trash",isloggedin, trashHistory)
